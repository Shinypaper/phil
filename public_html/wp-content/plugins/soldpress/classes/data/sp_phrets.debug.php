...
*/
	...
	private $last_server_body;


	public function sp_phRETS() { }
	...
	public function GetLastBodyResponse() {
		return $this->last_server_body;
	}
	...
	public function RETSRequest($action, $parameters = "") {
		...
		if ($this->catch_last_response == true) {
			...
			$this->last_server_body = $response_body;
		}
