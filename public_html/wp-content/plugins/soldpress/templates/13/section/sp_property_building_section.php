...
function sp_get_building_section(){

	global $sp_building_section_meta_reso;
	$data = sp_get_reso_data($sp_building_section_meta_reso);
	sp_table_generator('Building',$data);
	
}

function sp_get_building_section_xml(){
	global $sp_property_xml;
	global $sp_building_section_meta_xml;
	
	$data = sp_get_xml_data($sp_property_xml,$sp_building_section_meta_xml);
	sp_table_generator('Building',$data);
	
}

function sp_get_building()
{
	global $sp_property_xml;
