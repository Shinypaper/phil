...
function sp_scripts() {
	...
	$load_jquery_swipebox = get_option("sc-layout-jquery-swipebox",true);	
	if($load_jquery_swipebox)
	{
		wp_enqueue_script(
		'jquery.swipebox',
		SOLDPRESS_PLUGIN_URL. 'lib/swipebox-master/jquery.swipebox.min.js',
		array('jquery'), 
		'1.2.1', 
		true);
	}
...
{ 
	...
	if($theme == "bootstrap")
	{
		...
		SOLDPRESS_PLUGIN_URL.'lib/bootstrap/css/bootstrap.min.css', 
		array(), 
		'2.3.2', 
		'all' );		
		...
		if($isResponsive == 1)
		{
			...
			SOLDPRESS_PLUGIN_URL.'lib/bootstrap/css/bootstrap-responsive.css', 
			array(), 
			'2.3.2', 
			'all' );		
...
/*	$load_jquery_prettyPhoto = get_option("sc-layout-jquery-prettyPhoto",true);
	...
	$load_jquery_swipbox = get_option("sc-layout-jquery-swipbox",true);	
	if($load_jquery_swipbox)
	{
		wp_register_style( 'jquery.swipebox-style', 
			SOLDPRESS_PLUGIN_URL . 'lib/swipebox-master/swipebox.css', 
		array(), 
		'1.2.1', 
		'all' );		
		wp_enqueue_style( 'jquery.swipebox-style' );	
	}
