...
function chariot_google_fonts() {
	$protocol = is_ssl() ? 'https' : 'http';
	wp_enqueue_style( 'chariot-font', "$protocol://fonts.googleapis.com/css?family=Roboto+Slab:400,100,300,700" );
}
add_action( 'wp_enqueue_scripts', 'chariot_google_fonts' );
...
add_image_size( 'portfolio-thumb', 300, 400, true ); // Portfolio Thumb Only
add_image_size( 'team-thumb', 300, 400, true ); // Team Thumb Only
add_image_size( 'latest-post-thumb', 300, 400, true); // Latest Post Only
add_image_size( 'blog-post-thumb', 400, 300, true);	 // Post Thumb Only
...
// Get Link Back for Portfolio Template
...
// Get Link Back for Team Template
